...
- **Dashboard shell (`/admin`)** — a Server Component: four placeholder stat cards (Total Stays/Bookings/Experiences/Guides, "Not yet tracked"), an empty Recent-activity state, and disabled "Soon" quick actions (Add Stay, Manage Bookings, Manage Experiences). Structure only; wired to data + CRUD in later phases.
